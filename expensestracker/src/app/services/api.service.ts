...
export class ApiService {
  ...
  login(credentials: Credentials, errorCallback?: ErrorCallback) {
    return this.http
      .post<Token>(LOGIN_URL, JSON.stringify(credentials), httpOptions)
      .pipe(
        tap((token) => {
  ...
  createUser(user: User, errorCallback?: ErrorCallback) {
    return this.http
      .post<User>(CREATE_USER_URL, JSON.stringify(user), httpOptions)
      .pipe(
  ...
  getSpaceById(
    ...
    return this.http
      .get<Space>(SPACE_ID_URL.replace(':space_id', spaceId), httpOptions)
      .pipe(catchError((err) => this.handleError(err, errorCallback)));
  }
  ...
  createSpace(
    ...
    return this.http
      .post(SPACES_URL, spaceJson, httpOptions)
      .pipe(catchError((err) => this.handleError(err, errorCallback)));
  }
  ...
  deleteSpace(spaceId: string, errorCallback?: ErrorCallback) {
    return this.http
      .delete(SPACE_ID_URL.replace(':space_id', spaceId), httpOptions)
      .pipe(catchError((err) => this.handleError(err, errorCallback)));
  }
  ...
  patchExpense(
    ...
    return this.http
      .patch<Map<string, string>>(
        EXPENSE_ID_URL.replace(':space_id', spaceId).replace(
          ':expense_id',
          expense.expense_id
        ),
        expenseJson,
   ...
   * @param errorCallback Error callback
   */
  getCategoriesFromSpace(
    spaceId: string,
    errorCallback?: ErrorCallback
  ): Observable<Category[]> {
    return this.http
      .get<Category[]>(CATEGORY_URL.replace(':space_id', spaceId), httpOptions)
      .pipe(catchError((err) => this.handleError(err, errorCallback)));
  }
  ...
  deleteCategoryFromSpace(
    ...
    return this.http
      .delete<Category>(
        CATEGORY_ID_URL.replace(':space_id', spaceId).replace(
          ':category_id',
          categoryId
        ),
        httpOptions
  ...
  deleteUserFromSpace(
    ...
    return this.http
      .delete(
        SPACE_USER_ID_URL.replace(':space_id', spaceId).replace(
          ':username',
          username
        ),
        httpOptions
